<?php
   require_once('../koneksi.php');
    ...
    //memasukkan data ke dalam database
        ...
        if ($query) {
            echo "<script>alert('Berhasil memasukkan data pasien!'); document.location='inputdata.php'</script>";
        } else {
            "<script>alert('Memasukkan data gagal!'); document.location='inputdata.php'</script>";
        }
?>