   ...
   <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
         ...
         <div class="section-title">
            <h2>Covid Rangers <p>Login</p>
            </h2>
         </div>

         <div class="row justify-content-center">
            <div class="col-lg-8 mt-3 mt-lg-0 d-flex align-items-stretch">
               <form action="ceklogin.php" method="post" role="form" class="banners">
                  ...
                  <div class="form-group">
                     <label for="exampleInputPassword1" class="text-white">Anda adalah </label>
                     <select type="password" class="form-control" name="level">
                        <option value="Pengguna">Pengguna</option>
                        <option value="Admin">Admin</option>
                        <option value="Covid Rangers">Pegawai Covid Ranger</option>
                     </select>
                  </div>
                  <p class="text-white">Belum punya akun? <a href="index.php#daftar">Daftar disini!</a></p>
                  <a href="lupa.php">Lupa password?</a><p></p>
