...
<head>
   ...
   <title>Dashboard - Input Data Pasien</title>
         ...
         <li class="nav-item active">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
               <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <a class="collapse-item active" href="inputdata.php">Input Data</a>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <div class="container-fluid">
               ...
               <!-- Page Heading -->
               <h1 class="h3 mb-4 text-gray-800">Input Data Yang Terjangkit COVID-19</h1>
               <div class="row">
                  <div class="col-lg">
                     <!-- Brand Buttons -->
                           ...
                           <form action="statuspasien.php" method="POST">
                              ...
                              <div class="form-row">
                                 ...
                                 <div class="form-group col-md-2">
                                    ...
                                    <input type="text" name="kodepos" class="form-control" placeholder="14340"
                                       id="inputZip" autocomplete="off" required>
                                 </div>
