      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <div class="container-fluid">
               ...
               <!-- Page Heading -->
               <h1 class="h3 mb-2 text-gray-800">Donasi dari pengguna</h1>
               <p class="mb-4">Donasi ini diperuntukkan untuk seluruh pasien dan keluarganya yang terjangkit virus
                  covid-19. Donasi ini juga untuk meringankan beban saudara kita yang sedang mengalami dampak ekonomi
                  dari Pandemi Covid-19. Semoga Allah SWT. Tuhan Yang Maha Esa menggantinya dengan pahala yang berlipat
                  ganda.</p>
                  ...
                  <div class="col-xl-12 col-lg-7">
                     ...
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                           <h6 class="m-0 font-weight-bold text-primary">Donasi dari pengguna</h6>
                        </div>
                        <div class="card-body" style="overflow-x:auto;">
                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 <?php
                                    ...
                                    $query = "SELECT * FROM upload ORDER BY nama ASC LIMIT $limit_start, $limit";
                                 ...
                                 <tr>
                                    ...
                                    <td><img src='../buktitf/<?php echo $row["nama_file"]; ?>' height="50px" width="100px"></td>
                                 </tr>
                                 <?php } ?>
                              </tbody>
                           </table>
                           <!-- Paginations -->
                           <?php
                              $query_jumlah = "SELECT count(*) AS jumlah FROM upload";
